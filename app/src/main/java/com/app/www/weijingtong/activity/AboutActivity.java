...
import com.app.www.weijingtong.adapter.AboutAdapter;
import com.app.www.weijingtong.adapter.HomeListAdapter;
...
public class AboutActivity extends BaseActivity{
    ...
    private static final String REQUEST_URL = REQUEST_HOST +"?c=api&a=about";
        ...
        while(m.find()){
            ...
            spannableString.setSpan(new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    mToastStatic("start activity "+ aid + " - "+ text);
                }
